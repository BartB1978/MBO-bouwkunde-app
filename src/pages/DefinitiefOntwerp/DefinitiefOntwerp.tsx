...
function DefinitiefOntwerp() {
  const stage = bouwData.stadia.find(s => s.id === 'DO')!
  const workProcesses = bouwData.werkprocessen.filter(wp => wp.stadiumId === 'DO')

  return (
    <PageContainer
      title="Definitief Ontwerp (DO)"
      subtitle="Het definitieve ontwerp met alle technische details en specificaties"
      icon="📋"
    >
      <StageInfo stage={stage} />

      <StageTimeline stages={bouwData.stadia} currentStageId="DO" />
...
export default DefinitiefOntwerp
